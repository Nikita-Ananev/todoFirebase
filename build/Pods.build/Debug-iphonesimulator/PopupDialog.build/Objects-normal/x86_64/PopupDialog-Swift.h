...
- (nonnull instancetype)initWithTitle:(NSString * _Nullable)title message:(NSString * _Nullable)message image:(UIImage * _Nullable)image buttonAlignment:(enum UILayoutConstraintAxis)buttonAlignment transitionStyle:(enum PopupDialogTransitionStyle)transitionStyle preferredWidth:(CGFloat)preferredWidth tapGestureDismissal:(BOOL)tapGestureDismissal panGestureDismissal:(BOOL)panGestureDismissal hideStatusBar:(BOOL)hideStatusBar completion:(void (^ _Nullable)(void))completion;
- (nonnull instancetype)initWithViewController:(UIViewController * _Nonnull)viewController buttonAlignment:(enum UILayoutConstraintAxis)buttonAlignment transitionStyle:(enum PopupDialogTransitionStyle)transitionStyle preferredWidth:(CGFloat)preferredWidth tapGestureDismissal:(BOOL)tapGestureDismissal panGestureDismissal:(BOOL)panGestureDismissal hideStatusBar:(BOOL)hideStatusBar completion:(void (^ _Nullable)(void))completion OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
@property (nonatomic) enum UILayoutConstraintAxis buttonAlignment;
